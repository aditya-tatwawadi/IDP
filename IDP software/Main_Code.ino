  ...
  if (BlDist <= 600) {
    ...
    while(1) {
      ...
      if (digitalRead(LineM) == HIGH && (digitalRead(LineL) == HIGH || digitalRead(LineR) == HIGH)) { // this statement checks to see if a junction has been reached - then stops it and ends while loop.
        myMotorR->setSpeed(0);
        myMotorL->setSpeed(0);
        break;                                                          // the robot is now at the block
        }
    }                                                                                 
    ...
    }                                                          // robot is now back at the junction of the white square
  ...
  if (BlDist <= 600) {
    ...
    while(1) {
      ...
      if (digitalRead(LineM) == HIGH && (digitalRead(LineL) == HIGH || digitalRead(LineR) == HIGH)) { // this statement checks to see if a junction has been reached - then stops it and ends while loop.
        myMotorR->setSpeed(0);
        myMotorL->setSpeed(0);
        break;                                                          // the robot is now at the block at node E
        }
    }                                                                                 
    ...
    }                                                          // robot is now back at junction F
    ...
    }                                                          // robot is now back at white zone junction
