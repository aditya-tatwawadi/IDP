...
int LineFR = 8; //Far Right Line Sensor
int LineR = 4;
int LineL = 7;
int LineFL = 9; //Far Left Line Sensor
int StartButton = 6;
int LEDR = 3;
int LEDB = 10;
...
void GoToGreen() { //Green means that it is not magnetic
  ...
  myMotorR->setSpeed(MRF);
  myMotorL->setSpeed(MLB);
  delay(820);                  // this delay will need to be worked out until roughly 90* is achieved
  myMotorR->setSpeed(0);
  myMotorL->setSpeed(0);
  ...
  myMotorR->setSpeed(MRF);
  myMotorL->setSpeed(MLF);
  delay(4600);                           // change delay to work out best distance
  myMotorR->setSpeed(0);
  ...
  myMotorR->setSpeed(MRB);
  myMotorL->setSpeed(MLB);
  delay(4200);                           // change delay to work out best distance
  myMotorR->setSpeed(0);
